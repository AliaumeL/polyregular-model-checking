...
resWords =
  b "def" 21
    ...
    (b "mut" 31
       (b "enumerate" 26
          (b "else" 24 (b "done" 23 (b "do" 22 N N) N) (b "endif" 25 N N))
          (b "in" 29 (b "if" 28 (b "for" 27 N N) N) (b "let" 30 N N)))
       (b "then" 36
          (b "return" 34
             (b "or" 33 (b "not" 32 N N) N) (b "reversed" 35 N N))
          (b "{" 39 (b "yield" 38 (b "with" 37 N N) N) (b "}" 40 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
