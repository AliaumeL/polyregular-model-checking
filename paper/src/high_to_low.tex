...
\begin{tikzpicture}[overlay, remember picture]
    \draw[->, A2, thick] (pic cs:revloopexpstart) edge[bend right]      (pic cs:revloopexpinnerstart);
    \draw[->, A2, thick] (pic cs:revloopexpinnerstart) edge[bend right] (pic cs:revloopexpend);
    \draw[->, A2, thick] (pic cs:revloopifstart) edge[bend right]      (pic cs:revloopifend);

    \draw[A5, thick] ([yshift=1em, xshift=-0.5em]pic cs:revloopexpstart) 
                     rectangle 
                     ([yshift=0.1em, xshift=5em]pic cs:revloopexpend);
\end{tikzpicture}
\begin{align*}
