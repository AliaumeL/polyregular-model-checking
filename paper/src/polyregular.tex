...
functions: \kl{first-order string-to-string interpretations}. Every
interpretation defines a \kl{finitely supported} function $f : \mathcal{D}^*
\to \mathcal{D}^*$.

\todo[inline]{Do a paragraph about $\FO$ 
explaining how to evaluate it on words
and that it corresponds to automata, hence validity / satisfiability
are decidable.}
