...
\end{Highlighting}
\end{Shaded}
    \caption{Computing a function in our subset of Python, dependencies between indices and 
    list expressions are made explicit by thick red arrows.}
    \label{fig:python-example}
\end{figure}


\paragraph{Syntax.} Now, we can define the syntax of our high-level language.
