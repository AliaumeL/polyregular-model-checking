...
automata-based techniques. We say that a f $f$ is \intro{regularity preserving} if
...
exist uncomputable \kl{regularity preserving functions}, so such 
...
manipulating programs.\footnote{Note that for this extended model, being \kl{regularity
...
However, the proof of the \kl{regularity preserving} property for polyregular 
...
a simpler class of \kl{star-free polyregular functions}\footnote{
The notion of being \kl{star-free} has been extended to various classes of
...
Indeed, the satisfiability problem for \kl{first-order logic on finite words}, 
