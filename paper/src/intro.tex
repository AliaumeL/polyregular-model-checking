...
\cite{z3}, \intro{CVC5} \cite{cvc5}, and \intro{Alt-Ergo},\todo{cite altergo} generating proof
...
provide an efficient reduction of the verification of \kl{Hoare triples} to the
satisfiability of a \kl{first-order formula on words} in \cref{sec:pullback}.
In order to verify \kl{high-level programs}, we compile them into \kl{simple
