...
\NewDocumentCommand{\hlsettrue}{m}{\withkl{\kl[\hlsettrue]}{\; #1 \; \leftarrow \; \mathsf{true}}}
...
\NewDocumentCommand{\bnot}{m}{\withkl{\kl[\bnot]}{\neg #1}}
...
\NewDocumentCommand{\bliteq}{m m}{\withkl{\kl[\bliteq]}{#1 \; = \; #2}}
\knowledge{\bliteq}{notion}

\NewDocumentCommand{\bgen}{m}{\withkl{\kl[\bgen]}{\langle #1 \rangle}}
...
% Types
\NewDocumentCommand{\TList}{m}{\withkl{\kl[\TList]}{\cmdkl{[}{#1}\cmdkl{]}}}
\knowledge{\TList}{notion}

\NewDocumentCommand{\TChar}{}{\kl[\TChar]{\Sigma}}
\knowledge{\TChar}{notion}

\NewDocumentCommand{\TPos}{}{\kl[\TPos]{\mathsf{Pos}}}
...
\NewDocumentCommand{\TOut}{}{\kl[\TOut]{\mathsf{List}}}
