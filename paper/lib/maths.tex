...
\NewDocumentCommand{\hlifnoelse}{m m}{\withkl{\kl[\hlif]}{\cmdkl{\mathsf{if}} \; #1 \; \cmdkl{\mathsf{then}} \; #2}}
...
\NewDocumentCommand{\hlskip}{m}{\mathsf{skip}}
...
\NewDocumentCommand{\olist}{m}{\mathop{\kl[\olist]{\mathsf{list}}(#1)}}
...
\NewDocumentCommand{\semB}{ m m }{ \llbracket #1 \rrbracket_{#2}^{\mathsf{b}} }
\NewDocumentCommand{\semS}{ m m }{ \llbracket #1 \rrbracket_{#2}^{\mathsf{s}} }
\NewDocumentCommand{\semO}{ m m }{ \llbracket #1 \rrbracket_{#2}^{\mathsf{l}} }
\NewDocumentCommand{\semA}{ m m }{ \llbracket #1 \rrbracket_{#2}^{\mathsf{a}} }
\NewDocumentCommand{\semC}{ m }{ \llbracket #1 \rrbracket^{\mathsf{c}} }
\NewDocumentCommand{\semF}{ m m }{ \llbracket #1 \rrbracket_{#2}^{\mathsf{f}} }

\NewDocumentCommand{\Env}{}{\mathsf{Env}}



\NewDocumentCommand{\ibvar}{ m }{\mathsf{in}_{\mathbb{B}}(#1)}
\NewDocumentCommand{\obvar}{ m }{\mathsf{out}_{\mathbb{B}}(#1)}
\NewDocumentCommand{\ipvar}{ m }{\mathsf{in}_{\mathbb{N}}(#1)}



\NewDocumentCommand{\qrank}{  }{\mathop{\mathsf{qr}}}
\NewDocumentCommand{\bcount}{  }{\mathop{\#_\mathsf{bool}}}

\newcommand{\PSPACE}{\ensuremath{\mathsf{PSPACE}}}
\newcommand{\TOWER}{\ensuremath{\mathsf{TOWER}}}
