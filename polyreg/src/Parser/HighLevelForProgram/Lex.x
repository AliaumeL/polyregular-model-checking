...
resWords =
  b "def" 21
    (b "===" 11
       ...
       (b "False" 16
          (b "Bool" 14 (b ">=" 13 (b ">" 12 N N) N) (b "Char" 15 N N))
          (b "]" 19 (b "[" 18 (b "True" 17 N N) N) (b "and" 20 N N))))
    (b "or" 32
       (b "if" 27
          (b "else" 24
             (b "done" 23 (b "do" 22 N N) N) (b "for" 26 (b "endif" 25 N N) N))
          (b "mut" 30 (b "let" 29 (b "in" 28 N N) N) (b "not" 31 N N)))
       (b "with" 37
          (b "setTrue" 35
             (b "reversed" 34 (b "return" 33 N N) N) (b "then" 36 N N))
          (b "|" 40 (b "{" 39 (b "yield" 38 N N) N) (b "}" 41 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
